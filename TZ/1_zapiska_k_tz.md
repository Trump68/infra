...
Для реализации сценариев, перечисленных в п. 14.7, рекомендуется выделить специализированный **Backend Service**, который инкапсулирует вызовы внутренних сервисов и предоставляет фронтенду согласованный прикладной API.
