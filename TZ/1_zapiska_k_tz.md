...
Содержание пункта приведено в отдельном документе: [1.1. Подсистема входа, аутентификации и авторизации](1.1_subsystem_auth.md).
