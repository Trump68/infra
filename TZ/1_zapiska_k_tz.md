...
Указанный документ является частью пояснительной записки к Техническому заданию в части, касающейся § 12–14 настоящей записки.
