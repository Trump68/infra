...
## 10.1. Назначение и место в архитектуре
...
2. Generator формирует итоговый ответ с учетом контекста, ограничений доступа и требований к качеству.
3. В ответ включаются ссылки на использованные источники (цитирование: документ, раздел, при наличии страница/фрагмент).
...
## 10.12. Связанные документы

| Документ | Содержание |
|----------|------------|
| `TZ/1_zapiska_k_tz.md`, п. 13 | Конвейер RAG, гибридный поиск, BM25, RRF |
| `TZ/2_opisanie_po.md`, п. 3.2-3.3 | Retriever, векторная БД, типы документов |
| `Architecture.md`, разд. 6.4-6.5 | Retriever, индексация (по ссылкам в описании ПО) |
| "Пояснительная записка к ТЗ. Система интеллектуального поиска документов" | Детализация конвейера (при наличии в комплекте) |
