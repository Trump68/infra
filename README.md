...
```
cd existing_repo
git remote add origin http://git.nic.etu/anmatveev/farmadoc-infrastructure.git
git branch -M master
...
- [ ] [Set up project integrations](http://git.nic.etu/anmatveev/farmadoc-infrastructure/-/settings/integrations)
